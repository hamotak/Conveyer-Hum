...
import { getFileStream } from "@/lib/services/gdrive";
import { isLocalStockClipId, resolveLocalStockClipPath } from "@/lib/services/stock-library";
...
/** GET /api/stock/file?id=<driveFileId> — stream a stock clip for in-app preview. */
